...
```bash
dotnet dev-certs https -v -ep authserver.pfx -p 361b4ea9-f9d9-48de-ac3e-b4e3e400f6eb
```

> `361b4ea9-f9d9-48de-ac3e-b4e3e400f6eb` is the password of the certificate, you can change it to any password you want.
